...
export const DEFAULT_ITEMS: readonly Item[] = Object.freeze([
  Object.freeze({
    ...
    cost: SHOP_COST.STIM,
    description: `Restores ${STIM_HEAL} HP to the deployed crew member.`,
    needsTarget: true,
  }),
  Object.freeze({
    ...
    description: `Blocks LOS in radius ${SMOKE_RADIUS} for 1 turn.`,
    needsTarget: true,
  }),
  Object.freeze({
    id: ITEM_ID.MOLOTOV,
    ...
    description: `Throw one to damage enemies and deny them easy movement.`,
    needsTarget: true,
    needsAim: true,
  }),
  Object.freeze({
    ...
    description: `Destroys walls, locked doors, and reinforced objectives.`,
    needsTarget: true,
    needsAim: true,
  }),
]);

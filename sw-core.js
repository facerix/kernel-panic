...
const CacheConfig = {
  ...
  getCoreResources() {
    return [
      ...
      '/src/game/archetypeRewards.js',
      '/src/game/archetypes/Adept.js',
      '/src/game/archetypes/Berserk.js',
      '/src/game/archetypes/Chimera.js',
      '/src/game/archetypes/Decker.js',
      '/src/game/archetypes/index.js',
      '/src/game/archetypes/Merc.js',
      '/src/game/archetypes/Razor.js',
      '/src/game/archetypes/Tech.js',
      '/src/game/archetypeShowcase.js',
      '/src/game/archetypeUnlocks.js',
      '/src/game/breachBlast.js',
      '/src/game/Campaign.js',
      '/src/game/campaignSummary.js',
      '/src/game/chronicle.js',
      '/src/game/Combat.js',
      ...
      '/src/game/Crew.js',
      '/src/game/crewDisplay.js',
      '/src/game/crewStatRoll.js',
      '/src/game/cyber/CyberAvatar.js',
      '/src/game/cyber/cyberMapBuild.js',
      '/src/game/cyber/CyberspaceLayer.js',
      '/src/game/cyber/DataNode.js',
      '/src/game/cyber/EntryPort.js',
      '/src/game/cyber/GuardianIce.js',
      '/src/game/cyber/ProbeIce.js',
      '/src/game/cyber/SparkIce.js',
      '/src/game/describe.js',
      '/src/game/empBlast.js',
      '/src/game/encounters.js',
      '/src/game/endFlavor.js',
      ...
      '/src/game/entities/JackInPoint.js',
      ...
      '/src/game/Grid.js',
      '/src/game/Hostile.js',
      '/src/game/hub/ArchiveTerminal.js',
      ...
      '/src/game/incendiary.js',
      '/src/game/items.js',
      '/src/game/knockback.js',
      '/src/game/LineOfSight.js',
      '/src/game/locations.js',
      '/src/game/mapConnectivity.js',
      '/src/game/mindInfluence.js',
      '/src/game/nanoRepair.js',
      ...
      '/src/shell/activeView.js',
      '/src/shell/combatHudSnapshot.js',
      '/src/shell/domTypes.js',
      '/src/shell/locationHud.js',
      '/src/shell/musicScore.js',
